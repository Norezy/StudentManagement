...
function headerPDF() {
    $this->Image("C:/xampp/htdocs/SMS/images/assets/logo.png", 115, 1, 28);
    $this->SetFont('Times', 'B', 15);
    $this->Cell(30);
    $this->Cell(0, 4, utf8_decode('MUÑOZ INSTITUTE OF TECHNOLOGY'), 0, 1, 'C');
    $this->SetFont('Times', '', 12);
    $this->Cell(30);
    $this->Cell(0, 10, utf8_decode('Science City of Muñoz, Nueva Ecija, Philippines'), 0, 1, 'C');
    $this->Ln(10);
}
}
?>
