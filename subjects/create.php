...
<!-- end of sweetalert -->
    ...
    <div class = "container-xxl bg-white rounded-start-5 p-5" style="max-width: 100%; height: 120vh;">
        ...
        <div class="card mx-auto border-0" style="width:80%; height: 100%;">
            ...
            <h3 class="fw-bold mb-4" style="color: #061f5c; font-size: 30px; ">CREATE SUBJECT RECORD</h3>
                <form action="store.php" method="POST">
                    ...
                    <div class = "row">
                        <div class = "col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control border-0 border-bottom rounded-0 border-black shadow-none fs-5" id="code" name="code" value="<?= $code = date('YmdHis');?>" readonly>
                        </div>
                        <div class = "col-md-3 mb-3">
                            <label for="catalog-no" class="form-label fs-4">Catalog No.</label>
                            <input type="text" class="form-control border-0 border-bottom rounded-0 border-black shadow-none fs-5" id="catalog-no" name="catalog_no" placeholder="e.g., INTECH 2201" required>
                        </div>

                        <div class = "col-md-6 mb-3">
                            <label for="subject-name" class="form-label fs-4">Subject Name</label>
                            <input type="text" class="form-control border-0 border-bottom rounded-0 border-black shadow-none fs-5" id="subject-name" name="subject_name" placeholder="Enter Subject Name" required>
                        </div>
                    ...
                    <div class = "row">
                        ...
                        <div class = "col-md-2 mb-3">
                            ...
                            <input type="text" class="form-control border-0 border-bottom rounded-0 border-black shadow-none fs-5" id="day" name="day" placeholder="e.g., T/Th" required>
                        </div>
        
                        <div class = "col-md-2 mb-3">
                            <label for="time" class="form-label fs-4">Time</label>
                            <input type="text" class="form-control border-0 border-bottom rounded-0 border-black shadow-none fs-5" id="time" name="time" placeholder="e.g., 10:00 - 13:00" required>
                        </div>

                        <div class = "col-md-2 mb-3">
                            <label for="room" class="form-label fs-4">Room</label>
                            <input type="text" class="form-control border-0 border-bottom rounded-0 border-black shadow-none fs-5" id="room" name="room" placeholder="Enter Room" required>
                        </div>
